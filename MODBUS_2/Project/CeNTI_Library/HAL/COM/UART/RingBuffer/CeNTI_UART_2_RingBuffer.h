 ...
 * File:   CeNTI_UART_2_RingBuffer.h
 * Author: CeNTI
 *
...
#ifndef __PROJECT_CENTI_LIBRARY_HAL_COM_UART_RINGBUFFER_CENTI_UART_2_RINGBUFFER_H__
#define	__PROJECT_CENTI_LIBRARY_HAL_COM_UART_RINGBUFFER_CENTI_UART_2_RINGBUFFER_H__
...
/* ************************************************************************************ */
/**
 * @brief Initializes UART2 Ring buffer.
 * 
 * @param   None.
 * 
 ...
 * @return 	None.
 */
void UART_2_RingBuffer__ClearTxFIFO(void);
 ...
 * @return 	None.
 */
void UART_2_RingBuffer__ClearRxFIFO(void);

#if (defined(__CENTI_CODE_CONFIGURATOR_CUBEMX__))
    /** 
     * 
     */
    void UART_2_RingBuffer__Rx_Cb(UART_HandleTypeDef *huart);

    /** 
     * 
     */
    void UART_2_RingBuffer__Tx_Cb(UART_HandleTypeDef *huart);
#endif


#endif /* (defined(__CENTI_UART_2_RINGBUFFER__)) */

#endif /* __PROJECT_CENTI_LIBRARY_HAL_COM_UART_RINGBUFFER_CENTI_UART_2_RINGBUFFER_H__ */

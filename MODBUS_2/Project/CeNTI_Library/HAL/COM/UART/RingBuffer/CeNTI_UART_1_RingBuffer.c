 ...
 * File:   CeNTI_UART_1_RingBuffer.c
 * Author: CeNTI
 *
...
/* ************************************************************************************ */
        ...
        #error UART_1_RingBuffer needs to be configured with interrupts enabled!
    #endif
#endif
...
/* * Includes                                                                         * */
/* ************************************************************************************ */
#include "CeNTI_UART_1_RingBuffer.h"
#if (defined(__CENTI_CODE_CONFIGURATOR_ATMEL_START__))
    #error UART_1_RingBuffer does not support the CODE_CONFIGURATOR selected!
    ...
    #include "sl_uartdrv_usart_centi_uart_1_config.h"

    /* If CTS and RTS not defined, define a default value to avoid errors */
    #ifndef SL_UARTDRV_USART_CENTI_UART_1_CTS_PORT
        #define SL_UARTDRV_USART_CENTI_UART_1_CTS_PORT  gpioPortA
        #define SL_UARTDRV_USART_CENTI_UART_1_CTS_PIN   0
        #if defined(_USART_ROUTELOC1_MASK)
            #define SL_UARTDRV_USART_CENTI_UART_1_CTS_LOC   0
        #endif
    #endif

    #ifndef SL_UARTDRV_USART_CENTI_UART_1_RTS_PORT
        #define SL_UARTDRV_USART_CENTI_UART_1_RTS_PORT  gpioPortA
        #define SL_UARTDRV_USART_CENTI_UART_1_RTS_PIN   0
        #if defined(_USART_ROUTELOC1_MASK)
            #define SL_UARTDRV_USART_CENTI_UART_1_RTS_LOC   0
        #endif
    #endif
    /* Define RX and TX buffer queues */
    DEFINE_BUF_QUEUE(SL_UARTDRV_USART_CENTI_UART_1_RX_BUFFER_SIZE,\
                     sl_uartdrv_usart_centi_uart_1_rx_buffer);
    DEFINE_BUF_QUEUE(SL_UARTDRV_USART_CENTI_UART_1_TX_BUFFER_SIZE,\
                     sl_uartdrv_usart_centi_uart_1_tx_buffer);
...
/* ************************************************************************************ */
    ...
    #define UART1_TIMEOUT_TICK  (HAL_MAX_DELAY)
#endif
...
static t_UART_RingBuffer__Cb UART_1_CB__Rx;
/* Pointer to a outside function that will be called when a Tx interrupt occur. */
static t_UART_RingBuffer__Cb UART_1_CB__Tx;
    ...
    * @return None.
    */
    static void UART_1_ISR__Rx(SERCOM_USART_EVENT event, uintptr_t context);
    ...
    * @return None.
    */
    static void UART_1_ISR__Tx(SERCOM_USART_EVENT event, uintptr_t context);
    ...
    * @return None.
    */
   static void UART_1_ISR__Tx(struct UARTDRV_HandleData *   handle,
    ...
    * @return None.
    */
   static void UART_1_ISR__Rx(struct UARTDRV_HandleData *   handle,
                              Ecode_t                       transferStatus,
                              uint8_t *                     data,
                              UARTDRV_Count_t               transferCount);
...
{    
    ...
    UART_1_CB__Rx = NULL;
        ...
        SERCOM1_USART_WriteCallbackRegister(\
                (SERCOM_USART_RING_BUFFER_CALLBACK)UART_1_ISR__Tx, 0);  
        
        /* Set Rx callback function. */
        SERCOM1_USART_ReadCallbackRegister(\
                (SERCOM_USART_RING_BUFFER_CALLBACK)UART_1_ISR__Rx, 0);
        ...
        UART1_SetRxInterruptHandler(UART_1_ISR__Rx);
        UART1_SetTxInterruptHandler(UART_1_ISR__Tx);
        ...
        UARTDRV_InitUart_t sl_uartdrv_usart_init_centi_uart_1 = {
            .port     = SL_UARTDRV_USART_CENTI_UART_1_PERIPHERAL,
            .baudRate = SL_UARTDRV_USART_CENTI_UART_1_BAUDRATE,
            #if defined(_USART_ROUTELOC0_MASK)
                .portLocationTx = SL_UARTDRV_USART_CENTI_UART_1_TX_LOC,
                .portLocationRx = SL_UARTDRV_USART_CENTI_UART_1_RX_LOC,
            #elif defined(_USART_ROUTE_MASK)
                .portLocation = SL_UARTDRV_USART_CENTI_UART_1_ROUTE_LOC,
            #elif defined(_GPIO_USART_ROUTEEN_MASK)
                .txPort  = SL_UARTDRV_USART_CENTI_UART_1_TX_PORT,
                .rxPort  = SL_UARTDRV_USART_CENTI_UART_1_RX_PORT,
                .txPin   = SL_UARTDRV_USART_CENTI_UART_1_TX_PIN,
                .rxPin   = SL_UARTDRV_USART_CENTI_UART_1_RX_PIN,
                .uartNum = SL_UARTDRV_USART_CENTI_UART_1_PERIPHERAL_NO,
            #endif
            .stopBits     = SL_UARTDRV_USART_CENTI_UART_1_STOP_BITS,
            .parity       = SL_UARTDRV_USART_CENTI_UART_1_PARITY,
            .oversampling = SL_UARTDRV_USART_CENTI_UART_1_OVERSAMPLING,
            #if defined(USART_CTRL_MVDIS)
                .mvdis = SL_UARTDRV_USART_CENTI_UART_1_MVDIS,
            #endif
            .fcType  = SL_UARTDRV_USART_CENTI_UART_1_FLOW_CONTROL_TYPE,
            .ctsPort = SL_UARTDRV_USART_CENTI_UART_1_CTS_PORT,
            .rtsPort = SL_UARTDRV_USART_CENTI_UART_1_RTS_PORT,
            .ctsPin  = SL_UARTDRV_USART_CENTI_UART_1_CTS_PIN,
            .rtsPin  = SL_UARTDRV_USART_CENTI_UART_1_RTS_PIN,
            .rxQueue = (UARTDRV_Buffer_FifoQueue_t *)&sl_uartdrv_usart_centi_uart_1_rx_buffer,
            .txQueue = (UARTDRV_Buffer_FifoQueue_t *)&sl_uartdrv_usart_centi_uart_1_tx_buffer,
            #if defined(_USART_ROUTELOC1_MASK)
                .portLocationCts = SL_UARTDRV_USART_CENTI_UART_1_CTS_LOC,
                .portLocationRts = SL_UARTDRV_USART_CENTI_UART_1_RTS_LOC,
            #endif
        };
        ...
        ecode = UARTDRV_InitUart(sl_uartdrv_usart_centi_uart_1_handle,\
                                 &sl_uartdrv_usart_init_centi_uart_1);
                                ...
                                size_t    tx_vec_size)
{
    ...
    CENTI_CHECK_INIT(g_initialized);
       ...
       SERCOM1_USART_Write(&(tx_vec[0]), tx_vec_size);
        ...
        ecode = UARTDRV_Transmit(sl_uartdrv_usart_centi_uart_1_handle,\
                                 &(tx_vec[0]),\
                                 tx_vec_size,\
                                 UART_1_ISR__Tx);
                               ...
                               size_t    rx_vec_size)
{
    ...
    CENTI_CHECK_PTR(rx_vec);
        ...
        SERCOM1_USART_Read(&(rx_vec[0]), rx_vec_size);
        ...
        ecode = UARTDRV_Receive(sl_uartdrv_usart_centi_uart_1_handle,\
                                &(rx_vec[0]),\
                                rx_vec_size,\
                                UART_1_ISR__Rx);
...
/* ************************************************************************************ */
   ...
   static void UART_1_ISR__Rx(struct UARTDRV_HandleData *   handle,
    ...
    void UART_1_RingBuffer__Rx_Cb(UART_HandleTypeDef *huart)
...
#endif
{
    ...
    void UART_1_RingBuffer__Tx_Cb(UART_HandleTypeDef *huart)
